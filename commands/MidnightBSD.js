...
module.exports = {
    name: 'info-midnightbsd',
    aliases: ['info-midnight-bsd'],
	...
	execute(message) {
		const embed = new Discord.MessageEmbed()
            ...
            .setImage("https://fossbytes.com/wp-content/uploads/2020/11/MidnightBSD-2.0-Released-A-FreeBSD-Derived-OS-For-Desktop-Users.jpg")
            .addFields(
