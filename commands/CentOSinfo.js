...
module.exports = {
	...
	execute(message) {
		const embed = new Discord.MessageEmbed()
            ...
            .setImage('https://e-tinet.com/wp-content/uploads/2017/01/63646-centos-tudo-o-que-voce-precisa-saber-sobre-esta-distribuicao-linux-2.png')
            .addFields(
